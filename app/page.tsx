...
const friends: Friend[] = [
  {
    id: "user1",
    username: "pandalofy",
    displayName: "PANDALOFY",
    avatar: "/users/user1.png",
    description: "Ninguém Pode Me Encontrar.",
    skills: [
      { name: "Node.js", percentage: 95, color: "#68d391" },
    ...
    discordTag: "@pandalofy",
    status: "online",
  },
  {
    id: "user2",
    username: "polarlofy",
    displayName: "POLARLOFY",
    avatar: "/users/user2.png",
    description: "Sim E Meu Carro na foto",
    skills: [
      { name: "Node.js", percentage: 90, color: "#68d391" },
